...
// Method definitions for the module (assuming FKOMethods is already defined)

// Define module definition structure
static struct PyModuleDef fkocmodule = {
    PyModuleDef_HEAD_INIT,
    "_fko",   // Name of the module
    NULL,     // Module documentation (can be NULL)
    -1,       // Size of per-interpreter state of the module, or -1 if the module keeps state in global variables
    FKOMethods // Methods associated with this module
};
...
PyInit__fko(void)
{
    ...
    m = PyModule_Create(&fkocmodule);
    if (m == NULL)
        return NULL;

    // Create and add the custom exception
